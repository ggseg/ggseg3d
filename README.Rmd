...
If you want to create your own custom atlas or discover other compatible atlases, please see the companion package [ggsegExtra](https://lcbc-uio.github.io/ggsegExtra/).
...
You can access it [here](https://lcbc-uio.github.io/ggseg3d/articles/ggseg3d.html), or via R:
