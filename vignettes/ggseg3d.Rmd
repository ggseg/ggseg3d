...
You'll also need to notive the `label`, `annot` and `region` columns, which are likely the columns you will be matching on when proviging with your own data for colours. 
